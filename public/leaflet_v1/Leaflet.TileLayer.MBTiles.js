...
/*
ðŸ‚factory tileLayer.mbTiles(databaseUrl: String, options: TileLayer options)
Returns a new `L.TileLayer.MBTiles`, fetching and using the database given in `databaseUrl`.
ðŸ‚alternative
ðŸ‚factory tileLayer.mbTiles(databaseBuffer: Uint8Array, options: TileLayer options)
